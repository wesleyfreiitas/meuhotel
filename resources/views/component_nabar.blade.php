...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    <!-- Navbar Brand-->
    <a class="navbar-brand ps-3" href="index.html">Meu Hotel</a>
    <!-- Sidebar Toggle-->
        ...
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <a class="nav-link" href="{{ asset('/indicadores') }}">
                ...
                <!--<div class="sb-sidenav-menu-heading">Interface</div>-->
                    ...
                    <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="{{ asset('/reservas') }}">RESERVAS</a>
                            <a class="nav-link" href="{{ asset('/hospedes') }}">HOSPEDES</a>
                            <a class="nav-link" href="{{ asset('/quartos') }}">QUARTOS</a>
                            <a class="nav-link" href="{{ asset('/produtos') }}">PRODUTOS</a>
